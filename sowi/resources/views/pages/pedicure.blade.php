...
<div style="color: white; display: flex; justify-content: center; align-items: center; padding-top:125px; ">
    <div style="position: relative; background:#ffffff1f; width: 900px;  border-radius:15px ; padding: 25px;">
    <h1 style="font-weight:700; display: flex; justify-content: center; align-items: center; ">ПЕДИКЮР</h1><hr color="black">
    <div style="margin-top:25px;text-align: center;  ">
        @foreach($pedicures as $el)  
